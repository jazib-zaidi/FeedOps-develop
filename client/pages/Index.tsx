...
export default function Index() {
  ...
  const [isRawProductScreen, setIsRawProductScreen] = useState(false);
  const tableContainerRef = useRef<HTMLDivElement | null>(null);
  useEffect(() => {
    if (window.location.hash === "#row-product-data") {
      setIsRawProductScreen(true);
    } else {
      setIsRawProductScreen(false);
    }
  }, []);
      ...
      <div className="min-h-screen bg-[#F3F6F9] w-full">
        ...
        >
          <div className="mx-auto w-full flex-grow flex flex-col">
            <div className="">
              <SecondaryHeader
                title={isRawProductScreen ? "Raw Product Data" : "Products"}
                fullWidth
                isRawProductScreen={isRawProductScreen}
              >
                <ActionButtons isRawProductScreen={isRawProductScreen} />
              </SecondaryHeader>
            </div>
            ...
            {isRawProductScreen ? (
              <div className="">
                ...
                >
                        ...
                        <TooltipContent side="bottom">
                          <div className="text-sm">
                            ...
                            <div className="text-xs text-gray-500 mt-1">
                              Export product data to review fixes or identify
                              what needs updating. This can take some time.
                            </div>
                          </div>
                        </TooltipContent>
                      </Tooltip>
                  ...
                  <RawProductTable isFullscreen={isFullscreen} />
                </div>
              </div>
            ) : (
              <div
